# app.py - Versão COMPLETA com sistema de Categorias
import os
...
def gerenciar_produtos():
    if request.method == 'GET':
        ...
        for categoria in categorias:
            ...
            if produtos_da_categoria: # Só adiciona a categoria se ela tiver produtos
...
@app.route('/')
def home():
    return "<h1>API do Delivery - Versão com Categorias</h1><p>Acesse <a href='/admin'>/admin</a> para gerenciar os produtos.</p>"
...
def setup_database(app):
    with app.app_context():
        # A linha abaixo irá apagar e recriar seu banco de dados toda vez que a aplicação reiniciar.
        # É útil durante o desenvolvimento para testar a estrutura nova.
        # REMOVA ou COMENTE a linha db.drop_all() quando quiser que seus dados sejam permanentes.
        # db.drop_all()
        db.create_all()
